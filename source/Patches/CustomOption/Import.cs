...
namespace TownOfUs.CustomOption
{
    public class Import : CustomButtonOption
    {
        ...
        protected internal Import(int id) : base(id, MultiMenu.main, "加载自定义预设")
        {
            Do = ToDo;
        }
        ...
        {
            SlotButtons.Clear();
            SlotButtons.Add(new CustomButtonOption(1, MultiMenu.external, "预设 1", delegate { ImportSlot(1); }));
            SlotButtons.Add(new CustomButtonOption(1, MultiMenu.external, "预设 2", delegate { ImportSlot(2); }));
            SlotButtons.Add(new CustomButtonOption(1, MultiMenu.external, "预设 3", delegate { ImportSlot(3); }));
            SlotButtons.Add(new CustomButtonOption(1, MultiMenu.external, "预设 4", delegate { ImportSlot(4); }));
            SlotButtons.Add(new CustomButtonOption(1, MultiMenu.external, "预设 5", delegate { ImportSlot(5); }));
